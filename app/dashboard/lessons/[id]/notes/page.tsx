...
export default function LessonNotesPage() {
  ...
  const { data: course, isLoading: isLoadingCourse } = useCourse(params.id as string)
  const { data: enrollment, isLoading: isLoadingEnrollment } = useCheckEnrollment(params.id as string)
      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="flex items-center justify-center h-[calc(100vh-57px)]">
          <div className="text-center">
            <h2 className="text-xl font-semibold mb-4">Enroll to Access Notes</h2>
